...
class TestTreeUtils(unittest.TestCase):
    ...
    def test_check_tree_structure(self):
        ...
        self.assertNoException(
            tree_utils.check_tree_structure, [[1, 4], [2, 3], [], [], []]
        )
        self.assertNoException(
            tree_utils.check_tree_structure, [[1, 2], [3, 4], [], [], []]
        )
    ...
    def test_check_dfs_structure(self):
        ...
        self.assertNoException(
            tree_utils.check_dfs_structure, [[1, 4], [2, 3], [], [], []]
        )
        # test a valid tree which is not in DFS order
        self.assertException(
            tree_utils.check_dfs_structure, [[1, 2], [3, 4], [], [], []]
        )
