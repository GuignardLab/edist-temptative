...
class TestADP(unittest.TestCase):
    ...
    def test_backtrace_matrix(self):
        ...
        P_rep_expected[0, 0, 0] = 1.0
        P_rep_expected[0, 1, 1] = 1.0
        P_rep_expected[0, 2, 2] = 1.0
        P_del_expected = np.zeros((1, len(left)))
        P_del_expected[0, 3] = 1.0
